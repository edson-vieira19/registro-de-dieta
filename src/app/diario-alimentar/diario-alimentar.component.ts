...
export class DiarioAlimentarComponent implements OnInit, AfterViewInit{
  ...
  constructor(private service:UsuarioService,private alimentoService:AlimentoService, private route: ActivatedRoute){
  ...
  ngOnInit(): void {
    ...
    //chamada de métodos para obter propriedades
      //dos alimentos 
      this.totalCaloriasCafeManha = this.alimentoService.somaTotalCaloriasCafeManha(this.usuario);
      this.totalCaloriasAlmoco = this.alimentoService.somaTotalCaloriasAlmoco(this.usuario);
      this.totalCaloriasCafeTarde = this.alimentoService.somaTotalCaloriasCafeTarde(this.usuario);
      this.totalCaloriasJantar = this.alimentoService.somaTotalCaloriasJantar(this.usuario);
